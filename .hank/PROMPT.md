...
0c. For reference, the application source code is bash scripts at the repo root and in lib/.
...
9. When you learn something new about how to run the application, update @AGENT.md using a subagent but keep it brief.
...
14. IMPORTANT: Keep @AGENT.md operational only -- status updates and progress notes belong in IMPLEMENTATION_PLAN.md. A bloated AGENT.md pollutes every future loop's context.
