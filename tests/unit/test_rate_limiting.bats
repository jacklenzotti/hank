...
# Source hank functions (we need to extract these first)
setup() {
...
# Helper function: can_make_call (extracted from hank_loop.sh)
can_make_call() {
    local calls_made=0
...
# Helper function: increment_call_counter (extracted from hank_loop.sh)
